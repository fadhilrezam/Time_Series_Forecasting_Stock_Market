    ...
    try:
        ...
        with mlflow.start_run():
            ...
            try:
                ...
                mlflow.statsmodels.log_model(model_arima, signature=signature, input_example = input_example)
                print("Input example shape:", input_example.shape)
                print("Input example columns:", input_example.columns)
                print("Output example shape:", output_example.shape)
                print("Output example columns:", output_example.columns)
            ...
            try:
                ...
                folder_path = os.path.abspath(os.path.join(os.path.dirname(__file__),"..","visializations"))
